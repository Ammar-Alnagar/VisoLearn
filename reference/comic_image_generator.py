...
class ComicImageGenerator:
    ...
    def _create_quality_specifications(self, num_scenes):
        ...
        quality_specs = [
            ...
            "optimal contrast and saturation for maximum visual clarity",
    ...
    def _calculate_optimal_grid_layout(self, num_scenes):
        ...
        # Optimized layout preferences for better visual presentation
        optimal_layouts = {
            1: (1, 1),
            2: (1, 2),
            3: (1, 3),
            ...
            10: (2, 5),
            11: (1, 11),
            12: (3, 4),  # Optimal for 12 panels - professional comic book layout
            13: (1, 13),
            14: (2, 7),
            15: (3, 5),
            16: (4, 4),
            ...
            22: (2, 11),
            23: (1, 23),
            24: (4, 6),  # Optimal for 24 panels - professional comic book layout
        }
    ...
    def _create_enhanced_placeholder_comic(self, title, description, num_scenes):
        ...
        """
        # Calculate optimal dimensions based on scene count
        if num_scenes <= 4:
            width, height = 800, 600
        elif num_scenes <= 12:
