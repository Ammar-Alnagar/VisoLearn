...
def generate_prompt_from_options(difficulty, age, autism_level, topic_focus, treatment_plan="", image_style="Photorealistic"):
    ...
    query = f"""Create a detailed image generation prompt for a 16-scene educational composition. If the concept involves a child/minor, reinterpret and describe an adult equivalent instead.
...
3. CONTENT: All scenes relate to "{topic_focus}" and incorporate treatment plan elements. Replace any mention of a child/minor with an appropriate adult character.
...
End with: "16k resolution, crystal clear focus, zero blur, professional {image_style.lower()}, perfect anatomical accuracy and no speech bubbles "
